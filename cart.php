                            ...
                            if($n>0) {
                                ...
                                <div class="col-md-12 row my-3">
                                    ...
                                    <div class="col-md-7 text-white">
                                        ...
                                        Size : <?=$variance;?><br>
                                        <span class="text-white text-underline"> <strong>Rp.<?=number_format($price);?></strong> </span>
                        ...
                        <div class="container">
                            <div class="col-md-12">
                                <form action="<?=$base_url;?>/checkout.php" method="post">
                                    ...
                                    <button type="submit" name="btn" class="btn-block btn btn-success">Checkout</button>
                                </form> 
                            </div>
                        </div>
                    </div>
